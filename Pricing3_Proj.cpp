...
public:
    ...
    //It calculates the adjoint value that it's going to be used for reverse algorithm.
    ...
    inline double Adjoint(
        ...
        return Medium(adjoint_prod[0][it_options], size_adjoint[0][it_options]);
